    ...
    for sim in range(1,n_sim+1):
        ...
        for trial in range(1,n_trials+1):
            ...
            while(steps<=max_steps):
                ...
                text="\nStep = "+str(steps)+"| State = ("+str(agent_one.position)+","+str(prey.position)+","+str(predator.position)
                file.write(text)
